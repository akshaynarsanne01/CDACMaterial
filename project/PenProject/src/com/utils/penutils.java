...
public class penutils {
	...
	public static void serializePens(List<Pen> mylist, String fileName) {
		try(FileOutputStream fileout = new FileOutputStream(fileName);
			BufferedOutputStream bufferedOut = new BufferedOutputStream(fileout);
				ObjectOutputStream out = new ObjectOutputStream(bufferedOut)){
			out.writeObject(mylist);
			System.out.println("Pens are serialized and saved to File : "+ fileName);
	...
	public static void deserializePens(List<Pen> mylist, String fileName) {
		try (FileInputStream fileIn = new FileInputStream(fileName);
				BufferedInputStream bufferedIn = new BufferedInputStream(fileIn);
				ObjectInputStream in = new ObjectInputStream(bufferedIn)) {
			mylist = (List<Pen>) in.readObject();

			System.out.println("Pens deserialized from : "+fileName);

			for (Pen pen : mylist) {
				System.out.println(pen); // Print each pen in the list
			}
